$(function () {
    ...
    avalon.ready(function () {
        window.vmDetails = avalon.define({
            ...
            isGoods: true,
            onLoad: function () {
                for (var i in vmDetails.model.BudgetProject) {
                    if (vmDetails.model.BudgetProject[i] == null || vmDetails.model.BudgetProject[i] == 'undefined') {
                        vmDetails.model.BudgetProject[i] = '';
                    }
                }
                console.info('vmDetails.model');
                console.info(vmDetails.model);
                if (vmDetails.model.BudgetProject.ProjectType == '货物') {
                    vmDetails.isGoods = true;
                } else {
                    vmDetails.isGoods = false;
                }
                if (vmDetails.model.BudgetProject.ISCenterPurchase) {
                    vmDetails.name = '项目概况';
